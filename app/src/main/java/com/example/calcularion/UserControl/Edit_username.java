...
public class Edit_username extends exitsystem implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.accnum_back:
                ...
                Intent intent=new Intent(Edit_username.this, UserActivity.class);
            ...
            case R.id.accnum_next:
                ...
                Toast.makeText(Edit_username.this,zhanghao,Toast.LENGTH_LONG).show();
                if (qrcode.equals(getcode)){
                    if (Long.valueOf(accnum_acc.getText().toString().replaceAll(" " ,"") )==accnum){
                        ...
                        if (id<size){
                            ...
                            Intent intent1=new Intent(Edit_username.this,Edit_usernamelast.class);
                            intent1.putExtra("bundle",bundle);
                            intent1.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                            startActivity(intent1);
                        }
                        else{
                            Toast.makeText(Edit_username.this,"用户名与账号不匹配",Toast.LENGTH_LONG).show();
                            accnum_acc.setText("");
                        ...
                        Toast.makeText(Edit_username.this,"输入账号并非当前登录的账号",Toast.LENGTH_LONG).show();
                        accnum_acc.setText("");
                        accnum_qrcode.setText("");
                        accnum_username.setText("");
                        accnum_ivcode.setImageBitmap(QR_code.getInstance().createBitmap());
                    ...
                    Toast.makeText(Edit_username.this,"输入的验证码不正确",Toast.LENGTH_LONG).show();
                    accnum_acc.setText("");
                    accnum_qrcode.setText("");
                    accnum_username.setText("");
                    accnum_ivcode.setImageBitmap(QR_code.getInstance().createBitmap());
